  ...
  <div class="card col-3 p-0 m-1">
                ...
                <div class="card-body bg-dark">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Email: <a href="${manager.getEmail()}" target="blank">${
    manager.email
  }</a></li>
  ...
  <div class="card col-3 p-0 m-1">
                ...
                <div class="card-body bg-dark">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Email: <a href="${engineer.getEmail()}" target="blank">${
    engineer.email
  }</a></li>
                        <li class="list-group-item">GitHub: <a href="${engineer.getGithub()}" target="blank">${
  ...
  <div class="card col-3 p-0 m-1">
                ...
                <div class="card-body bg-dark">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">Email: <a href="${intern.getEmail()}" target="blank">${
    intern.email
  }</a></li>
